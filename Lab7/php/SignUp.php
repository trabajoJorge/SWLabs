  ...
  <section class="main" id="s1">
    <div>
        <form id="fquestion" name="fquestion" action="" method= "post" enctype="multipart/form-data">
            ...
            Email: <input type="text" name="email" id="email"  onfocusout='Comprobar_email()'><br>
            
            <div id='comprobar_email'>
                &nbsp;
            </div>
            
            
            Password: <input type="password" name="cont" id="cont" onfocusout='Comprobar_pass()'><br>
            <div id='comprobar_pass'>
                &nbsp;
            </div>
           ...
           echo "<script> alert('Alguna contraseña no es correcta');
            ...
            if (!$sqli){
                ...
                if (mysqli_num_rows($result)>0){
                    ...
                    $apatia= "INSERT INTO `Users` (`email`, `type`, `nombreApellido`, `pass`, `photo`) VALUES ('$email', '$tipo', '$NA', sha1('$cont'), '$img');";
