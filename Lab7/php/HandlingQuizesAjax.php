<?php session_start(); 
    if($_SESSION['admin']=='0' && $SESION['tipo']='profesor') {
?>
  ...
  <section class="main" style="height:100%;min-width:500px;" id="s1">
    ...
    <div>
        <form name="fquestion" enctype="multipart/form-data"  id="fquestion">
            Email (*): <input type=text value= "<?php echo $_SESSION["email"]?>" name="email" id="email" style="background-color:#CECECE;" readonly><br>
